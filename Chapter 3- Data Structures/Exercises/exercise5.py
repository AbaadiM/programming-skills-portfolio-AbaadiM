...
dinner_guest.pop(0)
dinner_guest.append('Isra')
print(dinner_guest)
print(f"Hala",dinner_guest[0],"please join us for dinner on Friday at 8:00 pm ")
print(f"Hala",dinner_guest[1],"please join us for dinner on Friday at 8:00 pm ")
print(f"Hala",dinner_guest[2],"please join us for dinner on Friday at 8:00 pm ")